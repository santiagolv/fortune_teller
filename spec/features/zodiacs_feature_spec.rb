...
RSpec.describe "The zodiac", type: :feature do
  it "aries displays the sign", points: 5 do
    visit "/zodiacs/aries"
  ...
  it "taurus displays the sign", points: 5 do
    visit "/zodiacs/taurus"

    expect(page).to have_content("taurus")
  ...
  it "gemini displays the sign", points: 5 do
  ...
  it "cancer displays the sign", points: 5 do
  ...
  it "leo displays the sign", points: 5 do
    visit "/zodiacs/leo"
  ...
  it "virgo displays the sign", points: 5 do
    visit "/zodiacs/virgo"
  ...
  it "libra displays the sign", points: 5 do
    visit "/zodiacs/libra"

    expect(page).to have_content("libra")
  ...
  it "scorpio displays the sign", points: 5 do
    visit "/zodiacs/scorpio"

    expect(page).to have_content("scorpio")
  ...
  it "sagittarius displays the sign", points: 5 do
    visit "/zodiacs/sagittarius"

    expect(page).to have_content("sagittarius")
  ...
  it "capricorn displays the sign", points: 5 do
  ...
  it "aquarius displays the sign", points: 5 do
    visit "/zodiacs/aquarius"

    expect(page).to have_content("aquarius")
  ...
  it "pisces displays the sign", points: 5 do
    visit "/zodiacs/pisces"

    expect(page).to have_content("pisces")
